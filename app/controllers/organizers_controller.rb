class OrganizersController < ApplicationController
  ...
  def destroy
    @organizer.task_organizers.delete_all
    @organizer.guests.delete_all
    @organizer.destroy
    respond_to do |format|
  ...
  private
    ...
    def organizer_params
      params.require(:organizer).permit(:nome, :matricula, :telefone, :email, 
      guests_attributes: [:id, :nome, :email, :_destroy])
    end
end
